...
#### CloudPC General settings ####
${API_SERVICE}      http://192.168.151.231:32102

#### Settings for common test cases ####
# windows10_pro_64bit_r01
${IMAGE_REF}        0c324442-e612-4709-a3b0-82ca9e45c5d4
# volume type: rbd1
${VOL_TYPE}			1ffb181a-7a40-468d-b3a0-81ec35b1a0ac

#### Settings for CloudPC test cases ####
${SERVER_NAME}      cloudx-server
